...
# test-consejo-casa-camino-conotuhseoathesotnhasoutk
...
# TODO: A better way to separate parentheses, si the git prompt can have different colors?
parse_git_branch() {
...
PROMPT_COMMAND='if [ $? = 0 ]; then QUOTE_COLOR="${GREEN}"; else QUOTE_COLOR="\e[1;31m"; fi'
