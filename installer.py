...
)  # NOTE: curl vimplug doesn't seem to work with snap pkm curl's version
os.system("sudo apt install -y npm")
os.system("sudo apt install -y pip")
os.system("sudo apt install -y grep")
os.system("sudo apt install -y black")
...
# Regular
os.system(
    "wget -cO - https://github.com/ryanoasis/nerd-fonts/blob/master/patched-fonts/JetBrainsMono/NoLigatures/Regular/complete/JetBrains%20Mono%20NL%20Regular%20Nerd%20Font%20Complete%20Mono.ttf > ./fonts/RegularJetMonoNL.ttf"
)
# Bold
os.system(
    "wget -cO - https://github.com/ryanoasis/nerd-fonts/blob/master/patched-fonts/JetBrainsMono/NoLigatures/Bold/complete/JetBrains%20Mono%20NL%20Bold%20Nerd%20Font%20Complete%20Mono.ttf > ./fonts/BoldJetMonoNL.ttf"
)
...
)  # NOTE: build-essential is to install cc1 dependency too (see Readme)
